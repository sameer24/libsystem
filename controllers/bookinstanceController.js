...
exports.bookinstance_detail = function (req, res, next) {
    BookInstance.findById(req.params.id)
        ...
        .exec(function (err, book_instance) {
            if (err) { return next(err); }
            res.render('bookinstance_detail', { title: 'Bookinstance Detail', bookinstance_detail: book_instance });
        });
...
exports.bookinstance_delete_get = function (req, res, next) {
    BookInstance.findById(req.params.id)
        ...
        .exec(function (err, book_instance) {
            if (err) { return next(err); }
            res.render('bookinstance_delete', { title: 'Delete Instance', bookinstance_detail: book_instance });
        });
};
...
exports.bookinstance_delete_post = function (req, res, next) {
    ...
    if (req.body.h1 == 'delete') {
        ...
        //res.send('NOT IMPLEMENTED: BookInstance delete POST'+req.body.h2);
    }
