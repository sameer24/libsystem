...
exports.book_delete_get = function(req, res, next) {
	async.parallel({
		...
		if (err) { return next(err);}
		res.render('book_delete',{title: 'Delete a Book', book : results.book, book_instance : results.book_instance});	
	});
...
//I am not happy with 'Tarikh pe Tarikh'. Please take it very seriously	
	async.parallel({
		book: function(callback) {
